...
stdid2=Label(root,text="basin width",padx=100,pady=10).grid(row=2,column=0)
b=Entry(root,width=20,borderwidth=5)
b.grid(row=2,column=1)



stdid3=Label(root,text="upstream velocity",padx=100,pady=10).grid(row=3,column=0)
u1=Entry(root,width=20,borderwidth=5)
u1.grid(row=3,column=1)
U1=u1.get()

stdid4=Label(root,text="expected tail-water depth",padx=100,pady=10).grid(row=4,column=0)
